...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        if ($cliente === false) {
         ...
         $image_file_metafin = '../../vistas/img/LOGO_RANSA.png';   
...
$rptaListCat = ControladorProductosDisensa::ctrConsultarProductosDisensa($_SESSION["idcliente"]);
