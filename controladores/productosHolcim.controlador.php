...
class ControladorProductosHolcim{
...
===========================================*/
	 ...
	 static public function ctrConsultarProductosHolcim($idcliente){

			$tabla = "productos";
			 $item = "idcliente";

			$rpta = ModeloProductosHolcim::mdlConsultarProductosHolcim($tabla,$item,$idcliente);
			return $rpta;
	}
