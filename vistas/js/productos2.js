    ...
    $.ajax({
      ...
      success: function(respuesta) {
        ...
        var mostrar = '<div class="col-xs-12 col-md-12">' +
          ...
          '<button type="button" idimagen = "portada" class="btn btn-primary btngirarRight" style="background-color: #F39200; border-color: #fff;"><span class="fa fa-rotate-right"></span></button>'+
          '</li>';
...
=====================================================*/
$('#datatableUserClienteSDisensa tbody').on("click", ".btnEditarProducto", function() {
  var idProducto = $(this).attr("idProducto");
