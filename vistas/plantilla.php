	...
	// || isset($_SESSION["validarSession"])
	 ...
	 if (isset($_GET['ruta']) ) {
		...
		// if (isset($_SESSION["validarSession"])) {
			...
			// include "modulos/vistaproductosDisena.php";

			// include "modulos/vistaproductosHolcim.php";
			// 	
...
<!-- 
<input type="hidden" value=" if(isset($_SESSION["ciudad"])){
...
<input type="hidden" value=" echo $url; " id="rutaOculta">

<input type="hidden" value=" if(isset($_SESSION["perfil"])){
...
<!--    <script type="text/javascript" src="<?php //echo $url; ?>extensiones/PowerBI/node_modules/powerbi-client/dist/powerbi.js"></script>
   ...
   <!-- CHART PARA GRAFICOS-->
	...
	<script src="<?php echo $url; ?>vistas/js/productos2.js"></script>

	<script src="<?php echo $url; ?>vistas/js/productos3.js"></script>
